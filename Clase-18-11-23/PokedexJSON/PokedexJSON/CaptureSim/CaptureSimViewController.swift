//
//  CaptureSimViewController.swift
//  PokedexJSON
//
...
class CaptureSimViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        let sceneSize = CGSize(width: view.bounds.width, height: view.safeAreaLayoutGuide.layoutFrame.height)
